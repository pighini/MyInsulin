    ...
    public partial class frm_login : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Modele.isCoOpen())
            {
                ...
                if (!Modele.UserExist(email))
                {
                    ...
                    {
                        lblErrorPassword.Text = "Password cannot be empty";
                    }
                    else
                    {
                        ...
                        {
                            lblRepeatPassword.Text = "Password doesn't match";
                        }
                        else
                        {
                ...
                {
                    lblErrorUsername.Text = "Username not available";
                }
            ...
            {
                lblErrorConnection.Text = "Check your internet connection";
            }
        }
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (Modele.isCoOpen())
            {
                ...
                {
                    lblErrorLogin.Text = "Invalid username and / or password";
                }
            }
            else
            {
